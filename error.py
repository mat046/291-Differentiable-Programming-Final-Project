...
class DuplicateVariable(UserError):
    ...
    first_declare_stmt : floma_diff_ir.stmt | floma_diff_ir.arg
    # the duplicate statement (or arg)
    duplicate_declare_stmt : floma_diff_ir.stmt | floma_diff_ir.arg
...
class UndeclaredVariable(UserError):
    ...
    stmt : floma_diff_ir.stmt | floma_diff_ir.expr
