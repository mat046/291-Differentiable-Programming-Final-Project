...
def check_duplicate_declare(node : floma_diff_ir.func):
...
def check_undeclared_vars(node : floma_diff_ir.func):
...
def check_return_is_last(node : floma_diff_ir.func):
...
def check_declare_bounded(node : floma_diff_ir.func):
...
def check_declares_are_outmost(node : floma_diff_ir.func):
...
def check_call_in_call_stmt(node : floma_diff_ir.func,
                            funcs : list[floma_diff_ir.func]):
...
def check_unhandled_differentiation(node : floma_diff_ir.func):
